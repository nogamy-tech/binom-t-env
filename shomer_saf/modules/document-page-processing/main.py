...
from app.application.page_processing_job import page_processing_query_bp

# =============================================================================
# LOGIC LAYER IMPORTS
# =============================================================================
from app.application.mock.mock_process import PageProcessingMockProcess   
from app.logic.page_processing_process import PageProcessingProcess
...
def create_app() -> Flask:
    ...
    # Blueprints (routes)
    app.register_blueprint(page_processing_query_bp, url_prefix="/shomer-saf/PageProcessing")

    # define service to run
    # app.config["DOC_PAGEPROC_LOGIC"] = PageProcessingMockProcess()
    app.config["DOC_PAGEPROC_LOGIC"] = PageProcessingProcess()
