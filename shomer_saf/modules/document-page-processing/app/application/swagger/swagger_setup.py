...
def setup_swagger_schemas(app, swagger):
    components = {
        "schemas": {
            ...
            "PageProcessingRequest": PageProcessingRequest.model_json_schema(ref_template="#/components/schemas/{model}"),
            "PageProcessingResponse": PageProcessingResponse.model_json_schema(ref_template="#/components/schemas/{model}")
        },
