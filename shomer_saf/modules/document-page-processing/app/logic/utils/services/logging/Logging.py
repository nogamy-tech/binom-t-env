...
class ExecutionLogger:
    def __init__(self, customer_id="document-page-process", filename="Logging", source="main", process_name="Shomer_Saf", project_name="", ministry_name="",dna_transaction_id=""):
    ...
    def log_execution(self, func):
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                self.logger.info(f"Finish document-page-process for: {customer_id}")
