...
def setup_swagger_schemas(app, swagger):
    components = {
        "schemas": {
            "BaseMessage": BaseMessage.model_json_schema(ref_template="#/components/schemas/{model}"),
            "DocumentPreProcessingRequest": DocumentPreProcessingRequest.model_json_schema(ref_template="#/components/schemas/{model}"),
            "DocumentPreProcessingResponse": DocumentPreProcessingResponse.model_json_schema(ref_template="#/components/schemas/{model}")
        },
