...
from app.application.document_start_job import document_start_job_bp

# =============================================================================
# LOGIC LAYER IMPORTS
# =============================================================================
from app.application.mock.mock_process import DocumentStartJobMockProcess
from app.logic.document_start_job_process import DocumentStartJobProcess
...
def create_app() -> Flask:
    ...
    app.register_blueprint(document_start_job_bp, url_prefix="/shomer-saf/StartJob")

    # define service to run
    # app.config["DOC_START_JOB_LOGIC"] = DocumentStartJobMockProcess()
    app.config["DOC_START_JOB_LOGIC"] = DocumentStartJobProcess()
    ...
    def root():
        ...
        """
        return jsonify(
            {"message": "Flask app is running. Go to /apidocs/ for Swagger."}
        )
