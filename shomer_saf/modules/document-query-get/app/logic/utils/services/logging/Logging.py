...
class ExecutionLogger:
    def __init__(self, customer_id="document-query-get", filename="Logging", source="main", process_name="Shomer_Saf", project_name="", ministry_name="",dna_transaction_id=""):
    ...
    def log_execution(self, func):
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                self.logger.info(f"Finish document-query-get for: {customer_id}")
