...
from app.application.document_query_get import document_query_get_bp

# =============================================================================
# LOGIC LAYER IMPORTS
# =============================================================================
from app.application.mock.mock_process import DocumentQueryGetMockProcess
from app.logic.document_query_get_process import DocumentQueryGetProcess
...
def create_app() -> Flask:
    ...
    app.register_blueprint(document_query_get_bp, url_prefix="/shomer-saf/QueryGet")

    # define service to run
    # app.config["DOC_QUERY_GET_LOGIC"] = DocumentQueryGetMockProcess()
    app.config["DOC_QUERY_GET_LOGIC"] = DocumentQueryGetProcess()
