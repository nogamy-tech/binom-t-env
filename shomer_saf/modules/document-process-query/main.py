...
from app.application.document_process_query_job import document_process_query_bp

# =============================================================================
# LOGIC LAYER IMPORTS
# =============================================================================
from app.application.mock.mock_process import DocumentQueryMockProcess
...
def create_app() -> Flask:
    ...
    # Blueprints (routes)
    app.register_blueprint(document_process_query_bp, url_prefix="/shomer-saf/ProcessQuery")

    # define service to run
    # app.config["DOC_PROCESSQUERY_LOGIC"] = DocumentQueryMockProcess()
    app.config["DOC_PROCESSQUERY_LOGIC"] = DocumentQueryProcess()
