...
# DocumentProcessQuery specific errors
...
class DataMissingError(APIError):
    """463 - Data Missing - File doesn't exist in DataBucketFolder"""
    def __init__(self, message="Data Missing", details=None):
        super().__init__(message, 463, "DATA_MISSING", details)


class TextModelTimeoutError(APIError):
    """467 - Text model timeout"""
    def __init__(self, message="Text Model Timeout", details=None):
        super().__init__(message, 467, "TEXT_MODEL_TIMEOUT", details)


class VisionModelTimeoutError(APIError):
    """468 - Vision model timeout"""
    def __init__(self, message="Vision Model Timeout", details=None):
        super().__init__(message, 468, "VISION_MODEL_TIMEOUT", details)


class ModelFailureError(APIError):
    """469 - Model failure"""
    def __init__(self, message="Model Failure", details=None):
        super().__init__(message, 469, "MODEL_FAILURE", details)


class DBTimeoutError(APIError):
    """470 - Database timeout"""
    def __init__(self, message="Database Timeout", details=None):
        super().__init__(message, 470, "DB_TIMEOUT", details)
