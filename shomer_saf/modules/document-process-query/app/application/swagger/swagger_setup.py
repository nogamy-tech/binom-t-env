...
def setup_swagger_schemas(app, swagger):
    components = {
        "schemas": {
            ...
            "DocumentProcessRequest": DocumentProcessRequest.model_json_schema(ref_template="#/components/schemas/{model}"),
            "DocumentProcessResponse": DocumentProcessResponse.model_json_schema(ref_template="#/components/schemas/{model}"),
